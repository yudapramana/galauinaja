        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-7">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="/privacy-policy" class="btn btn-outline-success px-4">Privacy Policy</a>
                </div>
            ...
            <div class="col-lg-5">
                <div class="p-4 bg-white border rounded-4 hero-shadow">
                    ...
                    <ul class="list-check small mb-3">
                        ...
                        <li>Functions & workflow described.</li>
                        <li>Scopes & purposes are disclosed.</li>
                        <li>Privacy Policy on verified domain.</li>
                    </ul>
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-lg-7">
                ...
                <p class="lead text-muted">
                    Aplikasi resmi <strong>Kementerian Agama Kabupaten Pesisir Selatan</strong> untuk mengunggah, memverifikasi,
            ...
            <div class="col-lg-5">
                <div class="p-4 bg-white border rounded-4 hero-shadow">
                    ...
                    <ul class="list-check small mb-3">
                        ...
                        <li>Deskripsi fungsi & alur kerja tersedia.</li>
                        <li>Izin & tujuan akses data dijelaskan.</li>
                        <li>Kebijakan Privasi pada domain terverifikasi.</li>
                    </ul>
                    <div class="note p-3 rounded-3 small">
                        Catatan: SIGARDA hanya meminta akses minimum yang diperlukan.
                    </div>
                </div>
            </div>
        </div>
