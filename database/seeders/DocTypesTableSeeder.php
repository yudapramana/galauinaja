...
class DocTypesTableSeeder extends Seeder
{
    public function run()
    {
        $docs = [
            ...
            ['SK Mutasi/Pindah dan SK Jabatan', 'SKMUT&JAB', true, true],
            ['SK Jabatan Pejabat Struktural Eselon III, IV, dan V', 'SKJABSTRUK', false, true],
            ['SK Jabatan Pejabat Fungsional bagi Kepala KUA dan Kepala Madrasah', 'SKJABFUNG', true, true],
            ['Surat Pernyataan Pelantikan', 'SPP', true],
            ['Berita Acara Sumpah Jabatan', 'BASUMPAH', true],
